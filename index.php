    ...
    <div class="container px-4 py-5 entete">
      <div class="row row-cols-1 row-cols-md-2 align-items-md-center g-5 py-5">
        ...
        <div id="lang" class="row row-cols-1 row-cols-sm-2 g-4" style="font-size: small;display: flex;justify-content: center;align-items: center;">
          <img src="img/niry.jpg" style="width: 400px; height: auto;">
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
        ...
        <div class="col">
          <div class="card h-100">
            <img src="img/aire.jpg" class="img-responsive img-fluid img-fluid " alt="Image">
            <div class="card-body">
              <p class="card-text"><?= _getText("projet.16")  ?></p>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <button data-bs-toggle="modal" data-bs-target="#exampleModal" data-description="<?= _getText("projet.16.desc") ?>" type="button" class="btn btn-sm btn-outline-secondary">
                    <?= _getText("vue") ?>
                  </button>
                </div>
                <small class="text-muted"><?= _getText("SITE") ?></small>
        ...
        <div class="col">
          <div class="card h-100">
            <img src="img/iray.org.jpg" class="img-responsive img-fluid img-fluid" alt="Image">
            <div class="card-body">
              <p class="card-text"><?= _getText("projet.17")  ?></p>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <button data-bs-toggle="modal" data-bs-target="#exampleModal" data-description="<?= _getText("projet.17.desc") ?>" type="button" class="btn btn-sm btn-outline-secondary">
                    <?= _getText("vue") ?>
                  </button>
                </div>
                <small class="text-muted"><?= _getText("SITE") ?></small>
                <small class="text-muted"><?= _getText("PHP") ?></small>
                <small class="text-muted"><?= _getText("MYSQL") ?></small>
                <small class="text-muted"><?= _getText("FULL STACK") ?></small>
                <small class="text-muted"><?= _getText("bootstrap") ?></small>
              </div>
            </div>
          </div>
        ...
        <div class="col">
          <div class="card h-100">
            <img src="img/megamadagame.jpg" class="img-responsive img-fluid img-fluid" alt="Image">
            <div class="card-body">
              <p class="card-text"><?= _getText("projet.18")  ?></p>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <button data-bs-toggle="modal" data-bs-target="#exampleModal" data-description="<?= _getText("projet.18.desc") ?>" type="button" class="btn btn-sm btn-outline-secondary">
                    <?= _getText("vue") ?>
                  </button>
                </div>
                <small class="text-muted"><?= _getText("SITE") ?></small>
